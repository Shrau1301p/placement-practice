...
public class repeated_que4 {
	
	public static final String ALPHABET = "abcdefghijklmnopqrstuvwxyz";   
	
	public static String CustomCaeserCipher(int key, String message) {
	...
	public static void main(String[] args) {
		try (Scanner scanner = new Scanner(System.in)) {
			...
			System.out.println("Encryption: "+ CustomCaeserCipher(key,plainText));
		}
	}
